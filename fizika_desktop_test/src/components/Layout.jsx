      ...
      <Content style={{ padding: '24px 16px 16px', overflow: 'initial' }}>
        <div  style={{ textAlign: 'center', minHeight: '100vh' }}>
          <Routes>
            ...
            <Route path='/isshi_oqiw_bagdarlamasi/:file' element={<Details  title={title} />} />
            <Route path='/annotaciya' element={<Annotaciya setTitle={setTitle} />} />
            <Route path='/annotaciya/:file' element={<Details  title={title} />} />
            <Route path='/pandasturi' element={<PanDasturi setTitle={setTitle} />} />
            <Route path='/pandasturi/:file' element={<Details  title={title} />} />
